  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white py-20 px-6 lg:px-20 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header */}
        <header className=" mb-10 md:mb-32">
          <span className="project-id opacity-0 translate-y-4 text-orange-500 font-mono text-[10px] md:text-sm tracking-[0.5em] mb-4 block">
            PROJECT_ID // {project.id}
          </span>
          <h1 className="project-title opacity-0 translate-y-10 md:text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.9]">
            {project.title}
          </h1>
        </header>
          ...
          {project.category.map((cat, i) => (
            <section key={i} className="cat-section opacity-0 translate-y-20 grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <div className="lg:col-span-4 lg:sticky lg:top-10 h-fit">
                <h2 className="md:text-3xl font-black uppercase tracking-tight text-white mb-6 border-b border-zinc-900 pb-4">
                  {cat.name}
                </h2>
              ...
              <div className="lg:col-span-8 bg-zinc-900/10 border border-zinc-900 p-3 md:p-8 lg:p-16 rounded-2xl md:rounded-[3rem]">
                <p className="text-zinc-300 text-justify text-sm md:text-lg lg:text-xl font-light leading-relaxed   ">
                  {cat.description}
                </p>
              </div>
